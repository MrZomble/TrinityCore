...
void World::LoadConfigSettings(bool reload)
{
    ...
    sIRC._Pass = ConfigMgr::GetStringDefault("irc.pass", "P@$$w0rd");
    sIRC._Nick = ConfigMgr::GetStringDefault("irc.nick", "Chatbot");
    ...
    sIRC.ajoin = ConfigMgr::GetIntDefault("irc.ajoin", 0);
    sIRC.ajchan = ConfigMgr::GetStringDefault("irc.ajchan", "Global");
...
void World::SetInitialWorldSettings()
{
    ...
    LoadConfigSettings();
	sLog.outString("Loading TrinityChat configuration settings...");
